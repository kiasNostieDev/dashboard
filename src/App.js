        ...
        <div className='inputleft'>
          <div className='inputdata'>
            <div className='inputcenter'>
              <input id='flag' onPaste={e=>e.preventDefault()} onDrop={e=>e.preventDefault()} onChange={e => {
                flag = e.nativeEvent.target.value
              }} placeholder='Flag Obtained'/>
              <input id='comp' onPaste={e => e.preventDefault()} onDrop={e => e.preventDefault()} onChange={e => {
                comp = e.nativeEvent.target.value
              ...
              <div style={{ margin: '0 auto', width: 'fit-content' }}><button onClick={() => {
                ...
                axios.post('https://ctfreg.herokuapp.com/enterflag', {
                  ...
                  else if (res.data === 'sorry bro... enter the registered name... duhh....') alert('Check the Name right there!')
